...
@section('title' , 'Vip fans - Lista de tareas')
@section('title_content' , 'Tareas')
@section('body')
	<div class="row">
	    <!-- Column -->
	    <div class="col-lg-12 col-md-12">
	        <div class="card">
	            <div class="card-body">
	                <h5 class="card-title">Tareas registradas</h5>
	                <a href="{{ url('/admin/magnetism/packages/create') }}" class="btn btn-primary" style="margin-bottom: 10px;">Agregar tarea</a>
	                @if(session()->has('msj'))
							...
							<tbody>
								@foreach($m as $c)
									<tr>
										...
										<td>
											<div class="btn-group">
												<a href="{{ url('/admin/magnetism/packages/'.$c->id.'/edit') }}" class="btn btn-sm btn-warning">Editar</a>
										        ...
										        <div class="modal-dialog" role="document">
										            <div class="modal-content">
										                ...
										                <div class="modal-body text-center">
										                	...
										                	<div class="btn-group">
										                		<a href="{{ url('/admin/magnetism/packages/updateStatus/'.$c->id) }}" class="btn btn-danger">Eliminar</a>
