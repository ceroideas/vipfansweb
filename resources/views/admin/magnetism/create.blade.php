...
@section('title' , 'Vip fans - Agregar tarea')
@section('title_content' , 'Agregar tarea')
@section('body')
	<style>
	    ...
	    <div class="col-lg-12 col-md-12">
	        <div class="card">
	            <div class="card-body">
	                ...
	                @endif
	                <form action="{{ url('/admin/magnetism/packages') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
	                	{{ csrf_field() }}
	                	<div class="row">
	                		<div class="col-lg-4">
	                		...
	                		<div class="col-lg-4">
	                			<div class="picker form-group">
									...
									<input type="text" name="icon" readonly class="inputpicker form-control" placeholder="Seleccione icono">
								</div>
	                		</div>
	                		<div class="col-lg-12">
	                			<div class="form-group">
	                		...
	                		@foreach($l as $la)
		                		<div class="col-lg-6">
				                	<div class="form-group">
				                		...
				                		<textarea name="answer_lang[]" id="answer_lang_{{ $la->id }}" class="form-control" cols="30" rows="10">{{ isset($te) && $te->getLang($la->iso , 'description') ? $te->getLang($la->iso , 'description')->value : '' }}</textarea>
